      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          <p className="text-[#f7f4ef]/80 text-lg sm:text-xl font-sans font-light max-w-lg mx-auto leading-relaxed mb-10">
            Capturing Australia&apos;s wild birds and hidden landscapes through
            patience, light, and reverence for the natural world.
          </p>
          <Link
            href="/gallery"
      ...
      <section className="bg-[#f7f4ef] py-20 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="font-serif text-4xl lg:text-5xl text-[#1e3520]">
              From the Field
            </h2>
          </div>
          ...
          <div className="masonry">
            {featuredPhotos.map((photo) => (
              <Link
                key={photo.id}
                href="/gallery"
                className="masonry-item block group relative overflow-hidden cursor-pointer"
              >
                <Image
                  src={photo.src}
                  alt={photo.alt}
                ...
                <div className="absolute inset-0 bg-[#1e3520]/0 group-hover:bg-[#1e3520]/50 transition-all duration-500 flex items-end">
                  <div className="p-5 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-400">
                    ...
                    <p className="text-[10px] tracking-[0.2em] uppercase text-[#f7f4ef]/60 font-sans mt-1">
                      {photo.category}
                    </p>
                  </div>
                </div>
      ...
      <section className="bg-[#1e3520] py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <p className="font-serif text-3xl sm:text-4xl lg:text-5xl text-[#f7f4ef] leading-relaxed italic">
            &ldquo;The forest is my cathedral,
            <br className="hidden sm:block" /> the birds my choir.&rdquo;
          </p>
