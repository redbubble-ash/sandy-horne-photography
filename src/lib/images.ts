...
export const photos: GalleryPhoto[] = [
  // Birds — real photos by Sandy Horne
  {
    id: "b1",
    src: "/images/gallery/birds/black-swan.jpg",
    width: 1597,
    height: 1597,
    alt: "Black Swan on still water",
    title: "Black Swan",
    category: "birds",
    featured: true,
  },
  {
    id: "b2",
    src: "/images/gallery/birds/nankeen-kestrel.jpg",
    width: 1595,
    height: 1595,
    alt: "Nankeen Kestrel perched",
  ...
  {
    id: "b3",
    src: "/images/gallery/birds/rainbow-bee-eater.jpg",
    width: 1591,
    height: 1591,
    alt: "Rainbow Bee-eater in flight",
  ...
  {
    id: "b4",
    src: "/images/gallery/birds/regent-parrot.jpg",
    width: 1585,
    height: 1585,
    alt: "Regent Parrot in the wild",
    title: "Regent Parrot",
    category: "birds",
    featured: true,
  },
  {
    id: "b5",
    src: "/images/gallery/birds/wedge-tailed-eagle.jpg",
    width: 1594,
    height: 1594,
    alt: "Wedge-tailed Eagle soaring",
  ...
  {
    id: "b6",
    src: "/images/gallery/birds/white-faced-heron.jpg",
    width: 1588,
    height: 1588,
  ...
  {
    id: "b7",
    src: "/images/gallery/birds/bird-portrait.jpg",
    width: 1714,
    height: 1714,
    alt: "Australian bird portrait",
    title: "Bird Portrait",
    category: "birds",
    featured: true,
  },
